		...
		<div class="panel-body">
			<div class="tab-content">
				...
				<div class="tab-pane" id="tab2primary">
					<div id="body-accordion-pose" role="tablist" aria-multiselectable="true">

						<div class="panel card clearfix">
							<div class="card-header" role="tab" id="body-heads">
								<h5>
									<a class="collapsed" data-toggle="collapse" data-parent="#body-accordion-pose" href="#body-head-data" aria-expanded="false" aria-controls="body-head-data"> Whole Figure </a>
								</h5>
							</div>
							<div id="body-head-data" class="collapse scroll" role="tabpanel" aria-labelledby="body-head">
								<div class="card-block">
						...
						<div class="panel card clearfix">
							<div class="card-header" role="tab" id="body-heads">
								<h5>
									<a class="collapsed" data-toggle="collapse" data-parent="#body-accordion-pose" href="#body-head-data" aria-expanded="false" aria-controls="body-head-data"> Head </a>
								</h5>
							</div>
							<div id="body-head-data" class="collapse scroll" role="tabpanel" aria-labelledby="body-head">
								<div class="card-block">
						...
						<div class="panel card clearfix">
							<div class="card-header" role="tab" id="body-arms">
								<h5>
									<a class="collapsed" data-toggle="collapse" data-parent="#body-accordion-pose" href="#body-arms-data" aria-expanded="false" aria-controls="body-arms-data"> Arms </a>
								</h5>
							</div>
							<div id="body-arms-data" class="collapse scroll" role="tabpanel" aria-labelledby="body-arms">
								<div class="card-block">
						...
						<div class="panel card clearfix">
							<div class="card-header" role="tab" id="body-hands">
								<h5>
									<a class="collapsed" data-toggle="collapse" data-parent="#body-accordion-pose" href="#body-hands-data" aria-expanded="false" aria-controls="body-hands-data"> Hands &amp; Items </a>
								</h5>
							</div>
							<div id="body-hands-data" class="collapse scroll" role="tabpanel" aria-labelledby="body-hands">
								<div class="card-block">
						...
						<div class="panel card clearfix">
							<div class="card-header" role="tab" id="body-chests">
								<h5>
									<a class="collapsed" data-toggle="collapse" data-parent="#body-accordion-pose" href="#body-chests-data" aria-expanded="false" aria-controls="body-chests-data"> Upper Body </a>
								</h5>
							</div>
							<div id="body-chests-data" class="collapse scroll" role="tabpanel" aria-labelledby="body-chests">
								<div class="card-block">
						...
						<div class="panel card clearfix">
							<div class="card-header" role="tab" id="body-legs">
								<h5>
									<a class="collapsed" data-toggle="collapse" data-parent="#body-accordion-pose" href="#body-legs-data" aria-expanded="false" aria-controls="body-legs-data"> Lower Body </a>
								</h5>
							</div>
							<div id="body-legs-data" class="collapse scroll" role="tabpanel" aria-labelledby="body-legs">
								<div class="card-block">
						...
						<div class="panel card clearfix">
							<div class="card-header" role="tab" id="body-feet">
								<h5>
									<a class="collapsed" data-toggle="collapse" data-parent="#body-accordion-pose" href="#body-feet-data" aria-expanded="false" aria-controls="body-feet-data"> Feet & Footware </a>
								</h5>
							</div>
							<div id="body-feet-data" class="collapse scroll" role="tabpanel" aria-labelledby="body-feet">
								<div class="card-block">
						...
						<div class="panel card clearfix">
							<div class="card-header" role="tab" id="body-base">
								<h5>
									<a class="collapsed" data-toggle="collapse" data-parent="#body-accordion-pose" href="#body-bases-data" aria-expanded="false" aria-controls="body-bases-data"> Base </a>
								</h5>
							</div>
							<div id="body-bases-data" class="collapse scroll" role="tabpanel" aria-labelledby="body-bases">
								<div class="card-block">
				...
				<div class="tab-pane" id="tab3primary">
					<div id="body-accordion-bones" role="tablist" aria-multiselectable="true">
						<div class="panel card clearfix">
							<div class="card-header" role="tab" id="body-heads">
								<h5>
									<a class="collapsed" data-toggle="collapse" data-parent="#body-accordion-bones" href="#body-head-data" aria-expanded="false" aria-controls="body-head-data"> Head </a>
								</h5>
							</div>
							<div id="body-head-data" class="collapse scroll" role="tabpanel" aria-labelledby="body-head">
								<div class="card-block">
						...
						<div class="panel card clearfix">
							<div class="card-header" role="tab" id="body-arms">
								<h5>
									<a class="collapsed" data-toggle="collapse" data-parent="#body-accordion-bones" href="#body-arms-data" aria-expanded="false" aria-controls="body-arms-data"> Arms </a>
								</h5>
							</div>
							<div id="body-arms-data" class="collapse scroll" role="tabpanel" aria-labelledby="body-arms">
								<div class="card-block">
						...
						<div class="panel card clearfix">
							<div class="card-header" role="tab" id="body-hands">
								<h5>
									<a class="collapsed" data-toggle="collapse" data-parent="#body-accordion-bones" href="#body-hands-data" aria-expanded="false" aria-controls="body-hands-data"> Hands &amp; Items </a>
								</h5>
							</div>
							<div id="body-hands-data" class="collapse scroll" role="tabpanel" aria-labelledby="body-hands">
								<div class="card-block">
						...
						<div class="panel card clearfix">
							<div class="card-header" role="tab" id="body-chests">
								<h5>
									<a class="collapsed" data-toggle="collapse" data-parent="#body-accordion-bones" href="#body-chests-data" aria-expanded="false" aria-controls="body-chests-data"> Upper Body </a>
								</h5>
							</div>
							<div id="body-chests-data" class="collapse scroll" role="tabpanel" aria-labelledby="body-chests">
								<div class="card-block">
						...
						<div class="panel card clearfix">
							<div class="card-header" role="tab" id="body-legs">
								<h5>
									<a class="collapsed" data-toggle="collapse" data-parent="#body-accordion-bones" href="#body-legs-data" aria-expanded="false" aria-controls="body-legs-data"> Lower Body </a>
								</h5>
							</div>
							<div id="body-legs-data" class="collapse scroll" role="tabpanel" aria-labelledby="body-legs">
								<div class="card-block">
						...
						<div class="panel card clearfix">
							<div class="card-header" role="tab" id="body-feet">
								<h5>
									<a class="collapsed" data-toggle="collapse" data-parent="#body-accordion-bones" href="#body-feet-data" aria-expanded="false" aria-controls="body-feet-data"> Feet & Footware </a>
								</h5>
							</div>
							<div id="body-feet-data" class="collapse scroll" role="tabpanel" aria-labelledby="body-feet">
								<div class="card-block">
						...
						<div class="panel card clearfix">
							<div class="card-header" role="tab" id="body-base">
								<h5>
									<a class="collapsed" data-toggle="collapse" data-parent="#body-accordion-bones" href="#body-bases-data" aria-expanded="false" aria-controls="body-bases-data"> Base </a>
								</h5>
							</div>
							<div id="body-bases-data" class="collapse scroll" role="tabpanel" aria-labelledby="body-bases">
								<div class="card-block">
