...
this.meshes['dragon buckler'] = new MeshMetadata('dragon buckler', 'stockto2', 'default', 'shields', []);
this.meshes['elvin shield'] = new MeshMetadata('elvin shield', 'stockto2', 'default', 'shield', []);
this.meshes['engraved buckler'] = new MeshMetadata('engraved buckler', 'stockto2', 'default', 'shields', []);
this.meshes['kite shield'] = new MeshMetadata('kite shield', 'stockto2', 'default', 'shields', []);
this.meshes['round buckler'] = new MeshMetadata('round buckler', 'stockto2', 'default', 'shields', []);
...
this.meshes['tower shield'] = new MeshMetadata('tower shield', 'stockto2', 'default', 'shields', []);
this.meshes['triangle shield'] = new MeshMetadata('triangle shield', 'stockto2', 'default', 'shields', []);
this.meshes['wooden buckler'] = new MeshMetadata('wooden buckler', 'stockto2', 'default', 'shields', []);
this.meshes['wooden shield'] = new MeshMetadata('wooden shield', 'stockto2', 'default', 'shields', []);
this.meshes['arcane staff a'] = new MeshMetadata('arcane staff a', 'stockto2', 'default', 'weapons', []);
this.meshes['arcane staff b'] = new MeshMetadata('arcane staff b', 'stockto2', 'default', 'weapons', []);
this.meshes['arcane staff c'] = new MeshMetadata('arcane staff c', 'stockto2', 'default', 'weapons', []);
this.meshes['arcane staff d'] = new MeshMetadata('arcane staff d', 'stockto2', 'default', 'weapons', []);
this.meshes['arcane staff e'] = new MeshMetadata('arcane staff e', 'stockto2', 'default', 'weapons', []);
...
this.meshes['battle axe a'] = new MeshMetadata('battle axe a', 'stockto2', 'default', 'weapons', []);
this.meshes['battle axe b'] = new MeshMetadata('battle axe b', 'stockto2', 'default', 'weapons', []);
this.meshes['battle axe c'] = new MeshMetadata('battle axe c', 'stockto2', 'default', 'weapons', []);
this.meshes['bone club'] = new MeshMetadata('bone club', 'stockto2', 'default', 'weapons', []);
this.meshes['bone club b'] = new MeshMetadata('bone club b', 'stockto2', 'default', 'weapons', []);
this.meshes['club a'] = new MeshMetadata('club a', 'stockto2', 'default', 'weapons', []);
this.meshes['club b'] = new MeshMetadata('club b', 'stockto2', 'default', 'weapons', []);
this.meshes['crossbow'] = new MeshMetadata('crossbow', 'stockto2', 'default', 'weapons', []);
this.meshes['cutlass'] = new MeshMetadata('cutlass', 'stockto2', 'default', 'weapons', []);
this.meshes['dagger a'] = new MeshMetadata('dagger a', 'stockto2', 'default', 'weapons', []);
this.meshes['decayed sword'] = new MeshMetadata('decayed sword', 'stockto2', 'default', 'weapons', []);
this.meshes['flail'] = new MeshMetadata('flail', 'stockto2', 'default', 'weapons', []);
this.meshes['glaive'] = new MeshMetadata('glaive', 'stockto2', 'default', 'weapons', []);
this.meshes['gnarled staff'] = new MeshMetadata('gnarled staff', 'stockto2', 'default', 'weapons', []);
this.meshes['great axe'] = new MeshMetadata('great axe', 'stockto2', 'default', 'weapons', []);
this.meshes['greatsword'] = new MeshMetadata('greatsword', 'stockto2', 'default', 'weapons', []);
this.meshes['halberd'] = new MeshMetadata('halberd', 'stockto2', 'default', 'weapons', []);
this.meshes['hammer'] = new MeshMetadata('hammer', 'stockto2', 'default', 'weapons', []);
this.meshes['hand axe a'] = new MeshMetadata('hand axe a', 'stockto2', 'default', 'weapons', []);
this.meshes['hand axe b'] = new MeshMetadata('hand axe b', 'stockto2', 'default', 'weapons', []);
this.meshes['knife'] = new MeshMetadata('knife', 'stockto2', 'default', 'weapons', []);
this.meshes['kris blade'] = new MeshMetadata('kris blade', 'stockto2', 'default', 'weapons', []);
this.meshes['long axe'] = new MeshMetadata('long axe', 'stockto2', 'default', 'weapons', []);
...
this.meshes['mace a'] = new MeshMetadata('mace a', 'stockto2', 'default', 'weapons', []);
this.meshes['mace b'] = new MeshMetadata('mace b', 'stockto2', 'default', 'weapons', []);
this.meshes['mace c'] = new MeshMetadata('mace c', 'stockto2', 'default', 'weapons', []);
this.meshes['mace d'] = new MeshMetadata('mace d', 'stockto2', 'default', 'weapons', []);
...
this.meshes['maul'] = new MeshMetadata('maul', 'stockto2', 'default', 'weapons', []);
this.meshes['orc sword'] = new MeshMetadata('orc sword', 'stockto2', 'default', 'weapons', []);
this.meshes['pistol'] = new MeshMetadata('pistol', 'stockto2', 'default', 'weapons', []);
this.meshes['pitchfork'] = new MeshMetadata('pitchfork', 'stockto2', 'default', 'weapons', []);
this.meshes['primitive spear'] = new MeshMetadata('primitive spear', 'stockto2', 'default', 'weapons', []);
this.meshes['quarterstaff'] = new MeshMetadata('quarterstaff', 'stockto2', 'default', 'weapons', []);
this.meshes['scimitar'] = new MeshMetadata('scimitar', 'stockto2', 'default', 'weapons', []);
...
this.meshes['shortsword b'] = new MeshMetadata('shortsword b', 'stockto2', 'default', 'weapons', []);
this.meshes['simple bow'] = new MeshMetadata('simple bow', 'stockto2', 'default', 'weapons', []);
this.meshes['spear a'] = new MeshMetadata('spear a', 'stockto2', 'default', 'weapons', []);
this.meshes['spear b'] = new MeshMetadata('spear b', 'stockto2', 'default', 'weapons', []);
this.meshes['spear c'] = new MeshMetadata('spear c', 'stockto2', 'default', 'weapons', []);
this.meshes['sunblade'] = new MeshMetadata('sunblade', 'stockto2', 'default', 'weapons', []);
this.meshes['sword a'] = new MeshMetadata('sword a', 'stockto2', 'default', 'weapons', []);
this.meshes['sword b'] = new MeshMetadata('sword b', 'stockto2', 'default', 'weapons', []);
this.meshes['sword c'] = new MeshMetadata('sword c', 'stockto2', 'default', 'weapons', []);
this.meshes['warhammer a'] = new MeshMetadata('warhammer a', 'stockto2', 'default', 'weapons', []);
this.meshes['warhammer b'] = new MeshMetadata('warhammer b', 'stockto2', 'default', 'weapons', []);
...
//this.meshes['female folded boots'] = new MeshMetadata('female folded boots', 'stockto2', 'default', 'footwear', []);
this.meshes['female gladiator sandals'] = new MeshMetadata('female gladiator sandals', 'stockto2', 'default', 'footwear', []);
//this.meshes['female high heeled boots'] = new MeshMetadata('female high heeled boots', 'stockto2', 'default', 'footwear', []);
//this.meshes['female leg armor'] = new MeshMetadata('female leg armor', 'stockto2', 'default', 'pants', []);
this.meshes['female legs'] = new MeshMetadata('female legs', 'stockto2', 'default', 'legs', []);
//this.meshes['female long pants 2'] = new MeshMetadata('female long pants 2', 'stockto2', 'default', 'pants', []);
this.meshes['female long pants'] = new MeshMetadata('female long pants', 'stockto2', 'default', 'pants', []);
//this.meshes['female loose shoes'] = new MeshMetadata('female loose shoes', 'stockto2', 'default', 'footwear', []);
//this.meshes['female pointed boots'] = new MeshMetadata('female pointed boots', 'stockto2', 'default', 'footwear', []);
//this.meshes['female sandals'] = new MeshMetadata('female sandals', 'stockto2', 'default', 'footwear', []);
//this.meshes['female simple boots'] = new MeshMetadata('female simple boots', 'stockto2', 'default', 'footwear', []);
//this.meshes['female simple shoes'] = new MeshMetadata('female simple shoes', 'stockto2', 'default', 'footwear', []);
this.meshes['female skirt basic'] = new MeshMetadata('female skirt basic', 'stockto2', 'default', 'pants', []);
this.meshes['female skirt billowy'] = new MeshMetadata('female skirt billowy', 'stockto2', 'default', 'pants', []);
this.meshes['female skirt long billowy'] = new MeshMetadata('female skirt long billowy', 'stockto2', 'default', 'skirts', []);
this.meshes['female skirt ragged'] = new MeshMetadata('female skirt ragged', 'stockto2', 'default', 'skirts', []);
this.meshes['female skirt slitted'] = new MeshMetadata('female skirt slitted', 'stockto2', 'default', 'skirts', []);
//this.meshes['female stitched boots'] = new MeshMetadata('female stitched boots', 'stockto2', 'default', 'footwear', []);
//this.meshes['female studded boots'] = new MeshMetadata('female studded boots', 'stockto2', 'default', 'footwear', []);
//this.meshes['female tall folded boots'] = new MeshMetadata('female tall folded boots', 'stockto2', 'default', 'footwear', []);
...
this.meshes['leg armor 2'] = new MeshMetadata('leg armor 2', 'stockto2', 'default', 'pants', []);
//this.meshes['leg armor'] = new MeshMetadata('leg armor', 'stockto2', 'default', 'pants', []);
...
this.meshes['male buckled shoes'] = new MeshMetadata('male buckled shoes', 'stockto2', 'default', 'footwear', []);
this.meshes['male folded boots'] = new MeshMetadata('male folded boots', 'stockto2', 'default', 'footwear', []);
this.meshes['male gladiator sandals'] = new MeshMetadata('male gladiator sandals', 'stockto2', 'default', 'footwear', []);
this.meshes['male long pants'] = new MeshMetadata('male long pants', 'stockto2', 'default', 'pants', []);
this.meshes['male longs pants 2'] = new MeshMetadata('male longs pants 2', 'stockto2', 'default', 'pants', []);
//this.meshes['male loose shoes'] = new MeshMetadata('male loose shoes', 'stockto2', 'default', 'footwear', []);
//this.meshes['male pointed boots'] = new MeshMetadata('male pointed boots', 'stockto2', 'default', 'footwear', []);
this.meshes['male sandals'] = new MeshMetadata('male sandals', 'stockto2', 'default', 'footwear', []);
this.meshes['male short pants'] = new MeshMetadata('male short pants', 'stockto2', 'default', 'pants', []);
this.meshes['male simple boots'] = new MeshMetadata('male simple boots', 'stockto2', 'default', 'footwear', []);
this.meshes['male simple shoes'] = new MeshMetadata('male simple shoes', 'stockto2', 'default', 'footwear', []);
//this.meshes['male stitched boots'] = new MeshMetadata('male stitched boots', 'stockto2', 'default', 'footwear', []);
this.meshes['male studded boots'] = new MeshMetadata('male studded boots', 'stockto2', 'default', 'footwear', []);
this.meshes['male tall folded boots'] = new MeshMetadata('male tall folded boots', 'stockto2', 'default', 'footwear', []);
this.meshes['male upper leg armor'] = new MeshMetadata('male upper leg armor', 'stockto2', 'default', 'pants', []);
...
this.meshes['wraith robe'] = new MeshMetadata('wraith robe', 'stockto2', 'default', 'robes', []);
	...
	refreshBoneGroupsList: function(){
		...
		this.boneGroups.put('legs', new BoneGroupMetadata('legs', 'dutchmogul', 'default', 'legs', ['cool', 'great'], ['legs', 'skirts', 'robes', 'pants', 'legwear', 'footwear', 'custom', 'shoes']));
